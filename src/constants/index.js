...
export const calculateSizes = (isSmall, isMobile, isTablet) => {
  return {
    ...
    cubePosition: isSmall ? [4, 7, 0] : isMobile ? [5, -5, 0] : isTablet ? [5, -5, 0] : [15, -12, 0],
    reactLogoPosition: isSmall ? [0, 0, 0] : isMobile ? [5, 4, 0] : isTablet ? [5, 4, 0] : [12, 3, 0],
    ringPosition: isSmall ? [-5, 7, 0] : isMobile ? [-10, 10, 0] : isTablet ? [-12, 10, 0] : [-20, 10, 0],
    targetPosition: isSmall ? [0, -5, -100] : isMobile ? [-9, -10, -10] : isTablet ? [-11, -7, -10] : [-13, -20, -10],
  };
};
